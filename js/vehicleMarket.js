...
slotHeader.className =
    "vehicle-market-slot-header";
...
slotFree.className =
    "vehicle-market-slot-free";

slotFree.textContent =
    freeStationSlots +
    " frei";


slotHeader.appendChild(
    slotTitle
);
...
slotBarFill.className =
    "vehicle-market-slot-bar-fill";


slotBarFill.style.width =
    (
        stationCapacity > 0
            ? (
                usedStationSlots /
...
slotUpgrade.className =
    "vehicle-market-slot-upgrade";
    ...
    function renderVehicleList() {
        ...
        availableTypes.forEach(
            function (type, index) {
                ...
                /*
                   Wenn kein Stellplatz mehr frei ist,
                   wird der Button deaktiviert.
                */
                ...
                if (
                    ...
                    buyButton.title =
                        "Kaufe zuerst einen weiteren Stellplatz für diese Wache.";
...
buyButton.addEventListener(
    ...
    function () {
        ...
        /*
           Sicherheitshalber direkt vor
           dem Kauf erneut prüfen.
        */
        ...
        if (
            ...
            alert(
                "Kein freier Stellplatz vorhanden.\n\n" +
                "Kaufe zuerst einen weiteren Stellplatz für diese Wache."
            );
        ...
        showConfirmation(
            ...
            vehicleName +
            "\" für " +
            vehicleCost.toLocaleString("de-DE") +
            " € wirklich kaufen?",
            function () {

                /*
                   Erst nach der Bestätigung
                   wird der eigentliche Kauf ausgeführt.
                */
