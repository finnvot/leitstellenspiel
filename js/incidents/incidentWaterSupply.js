...
export function createIncidentWaterSupply(
    ...
    return {
        ...
        connectedVehicles: [],
                ...
                /*
           Informationen über die aufgebauten
           Schlauchleitungen.
...
export function connectVehicleToHydrant(
    ...
    /*
       Ohne Schlauchleitung darf das Fahrzeug
       nicht mit dem Hydranten verbunden werden.
    */
    if (
        hoseCount <= 0
    ) {
    ...
    */
    ...
    incident.waterSupply.hoseLines[
        ...
        hydrantId:
            incident.waterSupply.hydrant.id ||
            null,
...
export function disconnectVehicleFromHydrant(
    ...
    /*
       Schlauchleitung ebenfalls entfernen.
    */
    if (
        incident.waterSupply.hoseLines
    ) {

        delete incident.waterSupply
            .hoseLines[
                vehicle.id
            ];
    ...
    /*
       Falls das Fahrzeug gerade
       Hydrantenwasser verwendet,
       zurück auf Tank stellen.
    */
    if (
        vehicle.waterSource &&
        vehicle.waterSource[
